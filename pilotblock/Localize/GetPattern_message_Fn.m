...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [FIP_L,FLENS,img] = GetPattern_message_Fn(Im,cname)
%global module
...
[FIPs,flen] = find_Probable_FIPs_Fn(img,cname);
if strcmp(cname,'qr')
[FIP_L,FLENS] = findFIP_Order_Fn(FIPs,flen,cname);
end
if strcmp(cname,'az')
FIP_L=FIPs;FLENS=flen;
end
end
